...
function D(e, n, t, l) {
  ...
  return (
    e.context &&
      ...
      t != 'statement' &&
      (u = e.context.indented),
    (e.context = new O(u, n, t, l, null, e.context))
  );
}
function x(e) {
...
function h(e) {
  ...
  function K(i, a) {
    ...
    var s = i.current();
    return m(l, s)
      ? (m(b, s) && (p = 'newstatement'), m(_, s) && (C = !0), 'keyword')
      : m(u, s)
        ? 'type'
        : m(d, s) || (U && U(s))
          ? (m(b, s) && (p = 'newstatement'), 'builtin')
          : m(w, s)
            ? 'atom'
            : 'variable';
  }
      ...
      return o.type == 'statement'
        ...
        : o.align && (!t || o.type != ')')
          ...
          : o.type == ')' && !v
            ...
            : o.indented +
              (v ? 0 : c.unit) +
              (!v && ue && !/^(?:case|default)\b/.test(a) ? c.unit : 0);
    },
    languageData: {
...
var T =
  ...
  se = r('int long char short double float unsigned signed void bool'),
  ...
  hooks: {
    ...
    indent: function (e, n, t, l) {
      ...
      if (
        ...
        (e.prevToken == 'variable' && u == '.') ||
        ((e.prevToken == '}' || e.prevToken == ')') && u == '.')
      )
...
export { h as clike, ke as csharp };
